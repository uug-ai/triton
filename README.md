...
> [`model-repository/`](model-repository) (YOLOv8 + YOLO26) and model export
> scripts ([`models/`](models)). The model **weights** are not committed — they
> are generated by the export scripts (see [Example models](#example-models)).
